...
require("kanagawa").setup({
	...
	overrides = function(colors) -- add/modify highlights
		...
		return {
			...
			BlinkCmpMenuBorder = { fg = theme.ui.float.bg, bg = theme.ui.bg },
...
vim.api.nvim_set_hl(0, '@keyword.sql', { link = 'Keyword' })
vim.api.nvim_set_hl(0, '@function.sql', { link = 'Function' })
vim.api.nvim_set_hl(0, '@string.sql', { link = 'String' })
vim.api.nvim_set_hl(0, '@type.sql', { link = 'Type' })
vim.api.nvim_set_hl(0, '@constant.sql', { link = 'Constant' })
