...
local options = {
  ...
  fillchars = { eob = " " }, -- Disable tildes on blank lines https://www.reddit.com/r/neovim/comments/144crhi/comment/jneqn66/?utm_source=share&utm_medium=web2x&context=3
